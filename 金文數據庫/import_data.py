...
# 选择列
columns = ['編號','器名','著錄','時代','出土','收藏','尺寸','器形','其他著錄','字數','銘文','備註','直接來源','其他']
df_selected = df[columns]

# 重命名列
df_selected.columns = ['編号','器名','著录','时代','出土','收藏','尺寸','器形','其他著录','字数','铭文','备注','直接来源','其他']
...
df_selected.to_sql('金文数据', conn, if_exists='append', index=False)
conn.commit()
conn.close()
